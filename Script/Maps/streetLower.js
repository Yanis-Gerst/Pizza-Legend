      ...
      talkingBox: [
        {
          box: [
            {
              type: "textMessage",
              text: "En tant que femme mon rôle est de soigner",
            },
            {
              type: "textMessage",
              text: "J'aime accomplir mon rôle et contribuer à la société",
            },
            { type: "healTeam" },
            {
              type: "textMessage",
              text: "Vos pizzas sont désormais soigner grâce au fait que je sois une femme",
            },
          ],
        },
      ],
      ...
      talkingBox: [
        ...
        },
        {
          box: [
            {
              type: "textMessage",
              text: "Yo le nouveau, Mister V à parlé de toi",
            },
            {
              type: "textMessage",
              text: "Je t'explique ici c'est une zone de combat tu peux le voir au panneau",
            },
            {
              type: "textMessage",
              text: "Ce sont tous des chefs pizza prêt à dahack",
            },
            {
              type: "textMessage",
              text: "Mais c'est un excellent entrainement",
            },
            {
              type: "textMessage",
            ...
            {
              type: "textMessage",
              text: "Je te conseille d'améliorer ton équipe pour cela t'as des pierre à pizzas à l'est.",
            },
          ],
        },
      ],
      ...
      talkingBox: [
        {
          box: [
            {
              type: "textMessage",
              text: "Moi je suis Caca le plus nul après Truc quand même.",
            },
      ...
      talkingBox: [
        {
          ...
          box: [{ type: "textMessage", text: "Vous avez battu un petit caca" }],
        },
        {
          box: [
            {
              type: "textMessage",
              text: "Moi je suis un caca mais plus petit",
            },
            {
              type: "textMessage",
              text: "Le saviez-vous Truc est si nul qu'il y a que le mot alain pour le décrire !",
            },
      ...
      talkingBox: [
        {
          ...
          box: [
            {
              type: "textMessage",
              text: "Azy me parle app, le mec après il te va déchirer",
            },
          ],
        },
        {
          box: [
            {
              type: "textMessage",
              text: "Moi je suis pas un caca mais le mec derrière il est le plus fort de la zone, Bonne chance",
            },
      ...
      talkingBox: [
        {
          ...
          box: [{ type: "textMessage", text: "Y'a plus de pizza mon reuf" }],
        },
        {
          requires: ["FIRST_WIN"],
          box: [
        ...
        },
        {
          box: [
            {
              type: "textMessage",
              text: "Viens me voir quand tu auras 1 Victoire",
            },
          ],
        },
      ],
      ...
      talkingBox: [
        ...
        },
        {
          box: [
            {
              type: "textMessage",
              text: "Viens me voir quand tu auras 3 Victoire",
            },
          ],
        },
      ],
