      ...
      talkingBox: [
        {
          ...
          box: [
            {
              type: "textMessage",
              text: "Bien joué maintenant que tu as prouvé que tu a certain niveau, tu peux accéder à ta première cuisine,",
              faceHero: "npc15",
              who: "Julio",
            },
            {
              type: "textMessage",
              text: " la Cuisine Verte, a l'intérieur un redoutable chef pizza Pizza d'attend",
              who: "Julio",
            },
            {
              type: "textMessage",
              text: "Ptit conseil sa pizza favorite est de type légume, bref y'a ses discipline a vaincre",
              who: "Julio",
            },
            {
              type: "textMessage",
              text: "Tu sais ce que  t'as à faire.",
              who: "Julio",
            },
          ],
        },
      ...
      talkingBox: [
        {
          ...
          box: [
            {
              type: "textMessage",
              text: "Ok Bat ma soeur maintenant",
              faceHero: "npc16",
            },
          ],
        },
        {
          box: [
            {
              type: "textMessage",
              text: "Yo on est des jumeles Vegan, on détéste les Samourai Kebab",
              faceHero: "npc16",
            },
            {
              type: "textMessage",
              text: "Pour rentrer dans la cuisine faudras que tu me passe sur le corp",
            },
      ...
      talkingBox: [
        {
          ...
          box: [
            {
              type: "textMessage",
              text: "Ok Bat Vegan Man maintenant",
              faceHero: "npc16",
            },
          ],
        },
