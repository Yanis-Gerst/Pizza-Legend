      ...
      talkingBox: [
        ...
        },
        {
          ...
          box: [
            {
              type: "textMessage",
              text: "Bravo, tu as gagné ton premier combat",
              faceHero: "npc2",
              who: "Mister V",
            },
            {
              type: "textMessage",
              text: "Maintenant va t'entrainer en ville, il y a de nombreux chefs",
              who: "Mister V",
            },
            {
              type: "textMessage",
              text: "Reviens me voir quand tu auras battu le grand chef de ce village",
              who: "Mister V",
            },
            {
              type: "textMessage",
              text: "Il se situe en tout en haut de la ville",
              who: "Mister V",
            },
          ],
        },
      ...
      talkingBox: [
        {
          box: [
            {
              type: "textMessage",
              text: "Moi je suis une victime, je fais toujours ce qu'on me dit",
            },
            {
              type: "textMessage",
              text: "Truc c'est mon vrai nom pour de vrai",
            },
          ],
        },
      ],
