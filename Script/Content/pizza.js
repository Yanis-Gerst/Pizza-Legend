...
window.pizzas = {
  s001: {
    ...
    src: "/Pizza-Legend/images/characters/pizzas/s001.png",
  ...
  v001: {
    ...
    src: "/Pizza-Legend/images/characters/pizzas/v001.png",
  ...
  c002: {
    ...
    src: "/Pizza-Legend/images/characters/pizzas/c002.png",
  ...
  c001: {
    ...
    src: "/Pizza-Legend/images/characters/pizzas/c001.png",
    icon: "images/icons/cheese.png",
  ...
  f001: {
    ...
    src: "/Pizza-Legend/images/characters/pizzas/f001.png",
...
window.pizzas.getTypeEffect = (typeAttack, typeTarget) => {
  if (typeAttack === "viande" && typeTarget === "veggie") {
    ...
    typeAttack === "veggie" &&
    (typeTarget === "fromage" || typeTarget === "piment")
  ) {
    return 2;
  } else if (
    typeAttack === "veggie" &&
    ...
    typeAttack === "fromage" &&
    (typeTarget === "viande" || typeTarget === "miel" || typeTarget === "spicy")
  ) {
    return 2;
  } else if (
    typeAttack === "fromage" &&
    (typeTarget === "veggie" || typeTarget === "piment")
  ) {
    return 0.5;
